...
rm183 <- read.delim('./Desktop/N Blast/18S_3UTR_5WS_200mEVAL_iden100-ONLY 7-ONLY 3UTR.txt', header=TRUE, sep = "\t")
...
write.csv(seq.frq.183, './Dropbox/Genetics/R/New Results/seq.frq.183-(7)-Eq.csv')
...
write.csv(match_hit, './Dropbox/Genetics/R/New Results/183Match_Hits.csv')
...
rm185 <- read.delim('./Desktop/N Blast/18S_5UTR_5WS_120mEVAL_iden100-ONLY 6-ONLY 5UTR.txt', header=TRUE, sep = "\t")
...
write.csv(seq.frq.185, './Dropbox/Genetics/R/New Results/seq.frq.185-(6)-2Eq.csv')
...
names(match_hit) <- c('rRNA','mRNA')
write.csv(match_hit, './Dropbox/Genetics/R/New Results/185Match_Hits.csv')
